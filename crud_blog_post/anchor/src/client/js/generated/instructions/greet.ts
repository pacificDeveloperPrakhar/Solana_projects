...
import { CRUD_BLOG_POST_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof CRUD_BLOG_POST_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof CRUD_BLOG_POST_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? CRUD_BLOG_POST_PROGRAM_ADDRESS;
