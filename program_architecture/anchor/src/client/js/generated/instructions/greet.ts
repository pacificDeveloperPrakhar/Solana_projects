...
import { PROGRAM_ARCHITECTURE_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof PROGRAM_ARCHITECTURE_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof PROGRAM_ARCHITECTURE_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? PROGRAM_ARCHITECTURE_PROGRAM_ADDRESS;
